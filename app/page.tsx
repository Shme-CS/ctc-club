    ...
    testimonials: [
      {
        ...
        content: 'CTC Club helped me transition from marketing to software development. The courses are practical and the mentors are amazing!',
        rating: 5,
      },
      {
        name: 'Michael Chen',
        ...
        content: 'The hands-on projects and real-world scenarios prepared me perfectly for my first developer job. Highly recommended!',
        rating: 5,
      },
      {
        ...
        content: 'Best investment in my career. The curriculum is up-to-date and the community support is incredible.',
        rating: 5,
      },
      {
        name: 'David Kim',
        ...
        content: 'From zero coding knowledge to landing my dream job in 6 months. CTC Club made it possible!',
        rating: 5,
      },
      {
        name: 'Lisa Anderson',
        ...
        content: 'The quality of instruction and the depth of content exceeded my expectations. Worth every penny!',
        rating: 5,
      },
      {
        name: 'James Wilson',
        ...
        content: 'CTC Club gave me the skills and confidence to switch careers. The support system is unmatched.',
        rating: 5,
      },
    ],
  };
